...
const AppState = {
  ...
  addToCart(product) {
    ...
    if (existingItem) {
     ...
     this.cart.push({ ...product, quantity: 1, image: product.image });
    }
    this.saveCart();
    this.updateCartUI();
...
const mockProducts = [
  { id: 1, name: 'Wireless Headphones', price: 99.99, description: 'High-quality wireless headphones with noise cancellation.', image: 'images/headphone.jpg' },
  { id: 2, name: 'Smart Watch', price: 299.99, description: 'Feature-rich smartwatch with health tracking.', image: 'images/smartwatch.jpg' },
  { id: 3, name: 'Laptop Stand', price: 49.99, description: 'Adjustable aluminum laptop stand for ergonomic working.', image: 'images/laptopstand.jpg' },
  { id: 4, name: 'USB-C Hub', price: 79.99, description: 'Multi-port USB-C hub with HDMI, USB 3.0, and charging.', image: 'images/usbhub.jpg' },
  { id: 5, name: 'Wireless Mouse', price: 39.99, description: 'Ergonomic wireless mouse with precision tracking.', image: 'images/wirelessmouse.jpg' },
  { id: 6, name: 'Mechanical Keyboard', price: 149.99, description: 'RGB mechanical keyboard with custom switches.', image: 'images/mechkeyboard.jpg' }
];
